...
Route::post('/v1/courses/{courseId}/notify', 'V1\CourseController@notify')->middleware('requireauth');
...
Route::get('/v1/membership/currentPeriod', 'V1\MembershipController@currentPeriod');
