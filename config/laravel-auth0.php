...
return array(
    ...
    */
    ...
    |
    */
    'client_id'     => env( 'AUTH0_FRONTEND_CLIENT_ID' ),
    ...
    |
    */
    'client_secret' => env( 'AUTH0_BACKEND_CLIENT_SECRET' ),
    ...
    */
    ...
    |
    */
    'authorized_issuers'  => [ env( 'AUTH0_BASE_URL' ) ],
    ...
    |
    */
    'api_identifier'  => env('AUTH0_BACKEND_API_IDENTIFIER'),
    ...
    */
    ...
    'state_handler' => env('AUTH0_STATE_HANDLER', null)
);